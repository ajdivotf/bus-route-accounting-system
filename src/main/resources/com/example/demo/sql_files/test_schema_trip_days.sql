...
INSERT INTO `trip_days` VALUES (1,'Понедельник',NULL,NULL),(2,'Вторник',NULL,NULL),(3,'Среда',NULL,NULL),(4,'Четверг',NULL,NULL),(5,'Пятница',NULL,NULL),(6,'Суббота',NULL,NULL),(7,'Воскресенье',NULL,NULL);
